...
/**
 * Specialised restore task for the faculty_tbird block
 * (requires encode_content_links in some configdata attrs)
 *
 * TODO: Finish phpdocs
 */
class restore_faculty_tbird_block_task extends restore_block_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_faculty_tbird_block_decode_content('block_instances', 'configdata', 'block_instance');
